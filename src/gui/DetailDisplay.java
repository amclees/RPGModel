...
public class DetailDisplay {
  ...
  public void display(int x, int y) {
    ...
    if (character == null)
      text.setText("No Character");
    else {
      text.setText("Level " + character.getLevel() + " " + character.getName() + "\n" + character.getHP() + " / "
          + character.getMaxHP() + " HP\n" + character.getFaction() + "\n" + "STR " + character.getStrength() + " DEX "
          + character.getDexterity() + " INT " + character.getIntelligence() + " WIS " + character.getWisdom() + " CON "
          + character.getConstitution() + " CHA " + character.getCharisma() + "\n" + "GUID " + character.getGUID());
    }
