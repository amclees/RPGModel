...
public class NPCRegistry {
  ...
  // Eventually make this a Map<String, CharacterTemplate>. Will not do now
  // because ICharacter is subject to change.
  ...
  public static void init() {
    ...
    // npcs.put(name, name, weight, strength, dexterity, wisdom, intelligence,
    // charisma, constitution, faction);
    ...
    npcs.put("Killua", new Human("Killua", 40.0d, 55, 85, 60, 28, 23, 35, "Hunter Association"));
    npcs.put("Gon", new Human("Gon", 40.0d, 50, 80, 70, 15, 32, 80, "Hunter Association"));

    // Should add to templates later
    // npcs.put("Bandit", new Human("Bandit", 50.0d, 25, 25, 25, 25, 25, 25,
    // "Bandits"));
